...
const RectInclusive FilterDemo::ORIGINAL_WINDOW = RectInclusive::make_rect(
    LEFT_OFFSET + HORIZONTAL_SPACING, 
    TOP_OFFSET + 10, 
    LEFT_OFFSET + HORIZONTAL_SPACING + WINDOW_WIDTH, 
    TOP_OFFSET + 10 + WINDOW_HEIGHT);
const RectInclusive FilterDemo::HFLIP_WINDOW = RectInclusive::make_rect(
    LEFT_OFFSET + HORIZONTAL_SPACING*2 + WINDOW_WIDTH, 
    TOP_OFFSET + 10, 
    LEFT_OFFSET + HORIZONTAL_SPACING*2 + WINDOW_WIDTH*2, 
    TOP_OFFSET + 10 + WINDOW_HEIGHT);
const RectInclusive FilterDemo::VFLIP_WINDOW = RectInclusive::make_rect(
    LEFT_OFFSET + HORIZONTAL_SPACING, 
    TOP_OFFSET + 10 + WINDOW_HEIGHT + VERTICAL_SPACING, 
    LEFT_OFFSET + HORIZONTAL_SPACING + WINDOW_WIDTH, 
    TOP_OFFSET + 10 + WINDOW_HEIGHT*2 + VERTICAL_SPACING);
const RectInclusive FilterDemo::ROTATION_WINDOW = RectInclusive::make_rect(
    LEFT_OFFSET + HORIZONTAL_SPACING*2 + WINDOW_WIDTH, 
    TOP_OFFSET + 10 + WINDOW_HEIGHT + VERTICAL_SPACING, 
    LEFT_OFFSET + HORIZONTAL_SPACING*2 + WINDOW_WIDTH*2, 
    TOP_OFFSET + 10 + WINDOW_HEIGHT*2 + VERTICAL_SPACING);
const RectInclusive FilterDemo::TRANSPARENCY_WINDOW = RectInclusive::make_rect(
    LEFT_OFFSET + HORIZONTAL_SPACING, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*2, 
    LEFT_OFFSET + HORIZONTAL_SPACING + WINDOW_WIDTH, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*2 + WINDOW_HEIGHT);
const RectInclusive FilterDemo::ALPHA_WINDOW = RectInclusive::make_rect(
    LEFT_OFFSET + HORIZONTAL_SPACING*2 + WINDOW_WIDTH, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*2, 
    LEFT_OFFSET + HORIZONTAL_SPACING*2 + WINDOW_WIDTH*2, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*2 + WINDOW_HEIGHT);
const RectInclusive FilterDemo::ZOOM_OUT_WINDOW = RectInclusive::make_rect(
    LEFT_OFFSET + HORIZONTAL_SPACING, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*3, 
    LEFT_OFFSET + HORIZONTAL_SPACING + WINDOW_WIDTH, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*3 + WINDOW_HEIGHT);
const RectInclusive FilterDemo::ZOOM_IN_WINDOW = RectInclusive::make_rect(
    LEFT_OFFSET + HORIZONTAL_SPACING*2 + WINDOW_WIDTH, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*3, 
    LEFT_OFFSET + HORIZONTAL_SPACING*2 + WINDOW_WIDTH*2, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*3 + WINDOW_HEIGHT);
const RectInclusive FilterDemo::LINEAR_GRADIENT_WINDOW = RectInclusive::make_rect(
    LEFT_OFFSET + HORIZONTAL_SPACING, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*4, 
    LEFT_OFFSET + HORIZONTAL_SPACING + WINDOW_WIDTH, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*4 + WINDOW_HEIGHT);
const RectInclusive FilterDemo::RADIAL_GRADIENT_WINDOW = RectInclusive::make_rect(
    LEFT_OFFSET + HORIZONTAL_SPACING*2 + WINDOW_WIDTH, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*4, 
    LEFT_OFFSET + HORIZONTAL_SPACING*2 + WINDOW_WIDTH*2, 
    TOP_OFFSET + 10 + (WINDOW_HEIGHT + VERTICAL_SPACING)*4 + WINDOW_HEIGHT);
